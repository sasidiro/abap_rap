CLASS zcl_generate_travel_data_828 DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS ZCL_GENERATE_TRAVEL_DATA_828 IMPLEMENTATION.


  METHOD if_oo_adt_classrun~main.

    DATA itab TYPE TABLE OF ztravel_828.
...
*   delete existing entries in the database table
    DELETE FROM ztravel_828.

*   insert the new table entries
    INSERT ztravel_828 FROM TABLE @itab.
